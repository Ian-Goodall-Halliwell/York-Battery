    ...
    if not 'full' in ftemp.split('_'):
        ...
        with open("Analysis/accuracy.csv","a",newline="") as f:
            newdict = {"Subject":resps['Subject'],
             ...
             "GoNoGo Task Response Time":np.mean(resps['GoNoGo Task']['Response Time']) if resps['GoNoGo Task']['Response Time'] != [] else "nan", "NoGo Task Accuracy":(resps['GoNoGo Task']['Accuracy - NoGo'].count(True)/len(resps['GoNoGo Task']['Accuracy - NoGo'])) if resps['GoNoGo Task']['Accuracy - NoGo'] != [] else "nan", "Go Task Accuracy":(resps['GoNoGo Task']['Accuracy - Go'].count(True)/len(resps['GoNoGo Task']['Accuracy - Go'])) if resps['GoNoGo Task']['Accuracy - NoGo'] != [] else "nan",
             "Finger Tapping Task Response Time":np.mean(resps['Finger Tapping Task']['Response Time']) if resps['Finger Tapping Task']['Response Time'] != [] else "nan", "Finger Tapping Task Accuracy":(resps['Finger Tapping Task']['Accuracy'].count(True)/len(resps['Finger Tapping Task']['Accuracy'])) if resps['Finger Tapping Task']['Accuracy'] != [] else "nan",
             "Two-Back Task-faces Response Time":np.mean(resps['Two-Back Task-faces']['Response Time']) if resps['Two-Back Task-faces']['Response Time'] != [] else "nan", "Two-Back Task-faces Accuracy":(resps['Two-Back Task-faces']['Accuracy'].count(True)/len(resps['Two-Back Task-faces']['Accuracy'])) if resps['Two-Back Task-faces']['Accuracy'] != [] else "nan",
             "Two-Back Task-scenes Response Time":np.mean(resps['Two-Back Task-scenes']['Response Time']) if resps['Two-Back Task-scenes']['Response Time'] != [] else "nan", "Two-Back Task-scenes Accuracy":(resps['Two-Back Task-scenes']['Accuracy'].count(True)/len(resps['Two-Back Task-scenes']['Accuracy'])) if resps['Two-Back Task-scenes']['Accuracy'] != [] else "nan",
             "One-Back Task Response Time":np.mean(resps['One-Back Task']['Response Time']) if resps['One-Back Task']['Response Time'] != [] else "nan", "One-Back Task Accuracy":(resps['One-Back Task']['Accuracy'].count(True)/len(resps['One-Back Task']['Accuracy'])) if resps['One-Back Task']['Accuracy'] != [] else "nan",
             "Zero-Back Task Response Time":np.mean(resps['Zero-Back Task']['Response Time']) if resps['Zero-Back Task']['Response Time'] != [] else "nan", "Zero-Back Task Accuracy":(resps['Zero-Back Task']['Accuracy'].count(True)/len(resps['Zero-Back Task']['Accuracy'])) if resps['Zero-Back Task']['Accuracy'] != [] else "nan",
             "Hard Math Task Response Time":np.mean(resps['Hard Math Task']['Response Time']) if resps['Hard Math Task']['Response Time'] != [] else "nan", "Hard Math Task Accuracy":(resps['Hard Math Task']['Accuracy'].count(True)/len(resps['Hard Math Task']['Accuracy'])) if resps['Hard Math Task']['Accuracy'] != [] else "nan",
             "Easy Math Task Response Time":np.mean(resps['Easy Math Task']['Response Time']) if resps['Easy Math Task']['Response Time'] != [] else "nan", "Easy Math Task Accuracy":(resps['Easy Math Task']['Accuracy'].count(True)/len(resps['Easy Math Task']['Accuracy'])) if resps['Easy Math Task']['Accuracy'] != [] else "nan",
             "Friend Task Response Time":np.mean(resps['Friend Task']['Response Time']) if resps['Friend Task']['Response Time'] != [] else "nan", "Friend Task Sentiment":(resps['Friend Task']['Sentiment'].count(True)/len(resps['Friend Task']['Sentiment'])) if resps['Friend Task']['Sentiment'] != [] else "nan",
             "You Task Response Time":np.mean(resps['You Task']['Response Time']) if resps['You Task']['Response Time'] != [] else "nan", "You Task Sentiment":(resps['You Task']['Sentiment'].count(True)/len(resps['You Task']['Sentiment'])) if resps['You Task']['Sentiment'] != [] else "nan"
             }
            writer = csv.writer(f)
