...
if __name__ == "__main__":
    ...
    self_other = taskgroup(
        [friendgroup, yougroup], "resources/group_inst/self_other.txt"
    )
    gonogo_fingtap = taskgroup(
        [gonogogroup, fingertapgroup], "resources/group_inst/gonogo_fingtap.txt"
    )
    reading_memory = taskgroup(
        [readinggroup, memorygroup], "resources/group_inst/reading_memory.txt"
    )
    oneback_zeroback = taskgroup(
        [zerobackgroup, onebackgroup], "resources/group_inst/oneback_zeroback.txt"
    )
    ezmath_hrdmath = taskgroup(
        [ezmathgroup, hardmathgroup], "resources/group_inst/ezmath_hrdmath.txt"
    )
    twobackTask_grp = taskgroup(
        [twobackfacegroup, twobackscenegroup], "resources/group_inst/ezmath_hrdmath.txt"
    )
